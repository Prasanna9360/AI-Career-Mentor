...
> 🖼️ **Screenshots will be added after deployment.**
> The UI features a premium dark glassmorphism design with 6 interactive tabs.

| Tab | What You'll See |
|---|---|
| 🏠 **Overview** | Career readiness score + top job matches |
| 🗺️ **Skill-to-Employment** | Weighted match % for 15 roles at 8 companies |
| 📋 **JD Matcher** | Paste any job description → instant skill gap analysis |
| 🗺️ **Career Roadmap** | Step-by-step learning path for your best-fit role |
| 📚 **Courses** | AI-curated courses for every missing skill |
| 🤖 **AI Copilot** | Career chatbot powered by Groq llama3 |
