...
const TESTIMONIALS = [
  {
    ...
    text: 'AI Career Mentor was a game-changer for my job search. The ATS analyzer helped me rewrite my resume from scratch. I went from 0 callbacks to 5 interviews in 2 weeks. The skill gap detection was incredibly accurate.',
    stars: 5,
    color: '#6366f1',
    initials: 'AS',
