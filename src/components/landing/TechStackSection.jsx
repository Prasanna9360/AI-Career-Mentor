...
const TECHNOLOGIES = [
  ...
  { name: 'Groq AI', icon: '🧠', color: '#ff6b35', category: 'AI/ML' },
  { name: 'NLP', icon: '💬', color: '#8b5cf6', category: 'AI/ML' },
  { name: 'Machine Learning', icon: '🤖', color: '#06b6d4', category: 'AI/ML' },
  { name: 'TensorFlow', icon: '🔶', color: '#ff8f00', category: 'AI/ML' },
  { name: 'OpenAI APIs', icon: '🌐', color: '#74aa9c', category: 'AI/ML' },
  { name: 'JWT Auth', icon: '🔐', color: '#ec4899', category: 'Security' },
  ...
  { name: 'GitHub', icon: '🐙', color: '#e2e8f0', category: 'DevOps' },
];
